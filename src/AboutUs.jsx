...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Plant Playground -- make new green friends! </p>
      <p className="about-us-content">
        At Plant Playground, we are passionate about bringing nature closer to you and having fun in the process.
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Plant Playground today and experience the 
